...
## [0.1.0-alpha.2](https://github.com/kahojyun/fricon/compare/v0.1.0-alpha.1...v0.1.0-alpha.2) - 2026-03-26

### Added

- enhance workspace migration error handling and validation logic ([#289](https://github.com/kahojyun/fricon/pull/289))
- improve dataset import archive version handling ([#288](https://github.com/kahojyun/fricon/pull/288))
- *(dataset)* add dataset portability import and export flows ([#271](https://github.com/kahojyun/fricon/pull/271))
- *(dataset)* add tombstone graveyard deletion ([#268](https://github.com/kahojyun/fricon/pull/268))
- implement dataset trashing and restoration functionality ([#266](https://github.com/kahojyun/fricon/pull/266))
- *(ui)* bring up running GUI for opened workspace ([#236](https://github.com/kahojyun/fricon/pull/236))
- *(datasets)* add dataset tag management ([#231](https://github.com/kahojyun/fricon/pull/231))
...
- *(fricon)* squash diesel migrations ([#291](https://github.com/kahojyun/fricon/pull/291))
- Improve workspace and IPC compatibility versioning ([#290](https://github.com/kahojyun/fricon/pull/290))
- improve test quality across Rust and frontend ([#279](https://github.com/kahojyun/fricon/pull/279))
- *(dataset-errors)* introduce typed dataset error handling ([#277](https://github.com/kahojyun/fricon/pull/277))
- enhance internal documentation ([#274](https://github.com/kahojyun/fricon/pull/274))
- simplify dataset create pipeline ([#265](https://github.com/kahojyun/fricon/pull/265))
- make fricon core app-centric ([#264](https://github.com/kahojyun/fricon/pull/264))
- reorganize fricon and fricon-ui architecture ([#226](https://github.com/kahojyun/fricon/pull/226))
