...
| --- | --------------------------------------------------------------------------------- | --------- | --------- | --- | ------- |
| A1  | Add `config.rs` module with `DatasetConfig` + load/save + validation              | 8,12,16   | -         | M   | Pending |
| A2  | Integrate config save/load path resolution in `DatasetManager`                    | 6,8       | A1        | S   | Pending |
| A3  | Add AppEvent variants (RowsAppended, ConfigUpdated)                               | 18,19     | -         | S   | Pending |
...
| A23 | Tests: Config + view validation                                                   | 8,12      | A1,A13    | S   | Pending |
