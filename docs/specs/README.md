...
derived from upstream sources and must not introduce product scope, domain
vocabulary, architecture decisions, or non-goals on its own.
...
- related domain concepts and invariants are accepted upstream
