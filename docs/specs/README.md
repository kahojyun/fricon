...
Do not create or use system-slice specs while product, architecture, or
...
derived from upstream sources and must not introduce product scope, product
terminology, architecture decisions, or non-goals on its own.
...
- related product concepts are accepted upstream
