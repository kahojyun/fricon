...
Current product analysis must not be steered by obsolete module boundaries.
...
- Project-specific implementation scaffolding should be recreated later from
  accepted product, architecture, and ADR inputs.
- Early implementation work should prefer replacing obsolete implementation
  boundaries in place over building a permanent parallel `fricon-v2` project.
