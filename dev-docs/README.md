...
| v0.2+ product or architecture reset         | `../docs-next/README.md`                 | `../docs-next/product/vision.md`, `../docs-next/domain/conceptual-model.md`, `../docs-next/architecture/README.md`                         | Treating old v0.2 proposal content as current behavior or source of truth |
| Measurement-system foundation redesign      | `../docs-next/product/story-map.md` | `../docs-next/domain/lifecycle-model.md`, `../docs-next/architecture/README.md`, `../docs-next/specs/README.md` | Treating archived proposal content or sentinel downstream docs as active implementation guidance |
