...
pub use self::{
    ...
    dataset::{
        ...
        ResolvedScanAxis, ResolvedScanAxisMode, ResolvedSemanticReference, ScalarArray, ScalarKind,
        ScanAxis, ScanAxisMode, ScanAxisValue, ScanPlan, SelectOptions, SemanticProjectionOptions,
