...
pub use self::{
    ...
    dataset::{
        ColumnMeaning, ColumnMetadata, DatasetArray, DatasetEvent, DatasetId,
        DatasetInterpretation, DatasetListQuery, DatasetMetadata, DatasetPhysicalSchema,
        DatasetPhysicalType, DatasetReader, DatasetRecord, DatasetRow, DatasetScalar,
        DatasetSortBy, DatasetStatus, DatasetUpdate, FixedStepTrace, PhysicalColumnOrdinal,
        ProjectedSemanticAxis, ProjectedSemanticRoles, ProjectedSemanticSource, ResolvedColumn,
        ...
        ScanPlan, SelectOptions, SemanticDescriptor, SemanticProjectionOptions, SemanticRole,
        SemanticShapeKind, SemanticValueKind, SortDirection, TraceKind, VariableStepTrace,
        VisibleColumnOrdinal, logical_index_id, physical_column_id, project_semantic_source,
    },
