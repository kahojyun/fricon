...
pub use self::{
    ...
    dataset::{
        ...
        FixedStepTrace, PhysicalColumnOrdinal, ProjectedSemanticAxis, ProjectedSemanticRoles,
        ProjectedSemanticSource, ResolvedColumn, ResolvedDuplicatePolicy, ResolvedIndexRealization,
        ResolvedLogicalIndexPoint, ResolvedLogicalIndexReference, ResolvedPhysicalColumnReference,
        ResolvedScanAxis, ResolvedScanAxisMode, ResolvedSemanticCapabilities,
        ResolvedSemanticDescriptor, ResolvedSemanticReference, ScalarArray, ScalarKind, ScanAxis,
        ScanAxisMode, ScanAxisValue, ScanPlan, SelectOptions, SemanticDescriptor,
        SemanticProjectionOptions, SemanticRole, SemanticShapeKind, SemanticValueKind,
        SortDirection, TraceKind, VariableStepTrace, VisibleColumnOrdinal, logical_index_id,
        physical_column_id, project_semantic_source,
    },
