...
pub use self::{
    ...
    dataset::{
        ...
        ResolvedScanAxis, ResolvedScanAxisMode, ResolvedSemanticKind, ResolvedSemanticReference,
        ScalarArray, ScalarKind, ScanAxis, ScanAxisMode, ScanAxisValue, ScanPlan, SelectOptions,
        SemanticProjectionOptions, SortDirection, TraceKind, VariableStepTrace,
