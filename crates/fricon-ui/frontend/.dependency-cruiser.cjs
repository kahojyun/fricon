  ...
  forbidden: [
    ...
    },
    {
      ...
      from: {
        ...
        pathNot: [
          ...
          "/test-utils[.](?:js|mjs|cjs|jsx|ts|mts|cts|tsx)$",
          "^src/shared/test/",
        ],
      },
      to: {
    ...
    },
    {
      ...
      from: {
        path: "^src/",
        pathNot:
          "^(?:src/features/[^/]+/api(?:/|$)|src/shared/lib/bindings\\.ts$|src/shared/lib/tauri\\.ts$|src/shared/test/|src/.+(?:\\.test\\.(?:ts|tsx)|/test-utils\\.tsx?)$)",
      },
...
// generated: dependency-cruiser@17.3.10 on 2026-04-01T19:13:01.188Z
