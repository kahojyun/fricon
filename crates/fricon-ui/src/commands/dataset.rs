...
use crate::{
    ...
    commands::{
        tags::normalize_tags,
        types::{DatasetInfo, UiDatasetSortBy, UiDatasetStatus, UiSortDirection},
    },
};
...
#[derive(Serialize, specta::Type)]
#[serde(rename_all = "camelCase")]
pub(super) struct DatasetDetail {
    id: i32,
    name: String,
    description: String,
    favorite: bool,
...
#[derive(Serialize, specta::Type)]
#[serde(rename_all = "camelCase")]
pub(super) struct DatasetWriteStatus {
    row_count: usize,
    is_complete: bool,
}
...
#[serde(rename_all = "camelCase")]
pub(super) struct DatasetListOptions {
    #[specta(optional)]
...
#[serde(rename_all = "camelCase")]
pub(super) struct DatasetFavoriteUpdate {
    favorite: bool,
}

#[derive(Deserialize, specta::Type)]
#[serde(rename_all = "camelCase")]
pub(super) struct DatasetInfoUpdate {
    #[specta(optional)]
    name: Option<String>,
    #[specta(optional)]
...
#[tauri::command]
#[specta::specta]
pub(super) async fn get_workspace_info(
...
#[tauri::command]
#[specta::specta]
pub(super) async fn list_dataset_tags(
    state: State<'_, AppState>,
...
#[tauri::command]
#[specta::specta]
pub(super) async fn dataset_detail(
    state: State<'_, AppState>,
    id: i32,
...
#[tauri::command]
#[specta::specta]
pub(super) async fn update_dataset_favorite(
    state: State<'_, AppState>,
    id: i32,
...
#[tauri::command]
#[specta::specta]
pub(super) async fn update_dataset_info(
    state: State<'_, AppState>,
    id: i32,
...
#[tauri::command]
#[specta::specta]
pub(super) async fn get_dataset_write_status(
    state: State<'_, AppState>,
    id: i32,
